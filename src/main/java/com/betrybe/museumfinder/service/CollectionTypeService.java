...
public class CollectionTypeService {
   ...
   */
  public MuseumCreationDto countByCollectionTypes(String typesList) {
    ...
    if (totalCount > 0) {
      return new MuseumCreationDto(collectionTypes, totalCount);
    } else {
      return new MuseumCreationDto(collectionTypes, 0);
    }
  }
